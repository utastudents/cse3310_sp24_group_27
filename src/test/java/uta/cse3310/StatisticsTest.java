...
//          assertEquals(4, stats.getPlayerRank(PlayerType.PLAYERFOUR).intValue());
//          assertEquals(3, stats.getPlayerRank(PlayerType.PLAYERONE).intValue());
//          assertEquals(1, stats.getPlayerRank(PlayerType.PLAYERTWO).intValue());
//          assertEquals(2, stats.getPlayerRank(PlayerType.PLAYERTHREE).intValue());
//      }
